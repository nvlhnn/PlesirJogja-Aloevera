    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="/buyticket" method="post">
            ...
            <input type="hidden" name="kode_pembayaran" value="<?php echo e($id_pemesanan); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projek\laravel\pabw_plesirjogja\resources\views/Places/show.blade.php ENDPATH**/ ?>