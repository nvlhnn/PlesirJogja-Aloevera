...
<body>
    <div id="app">
        ...
        <div style="background-color: #579654; position: fixed; width: 100%; margin-top: 55px; z-index: 20; opacity: 90%; color: white; height: 55px">
            ...
            <div class="container" style="margin-left: 42%">
                <?php if(session()->has('notifLogin')): ?>
                    <div class="row">
                        <div class="alert alert-success" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            <?php echo e(session()->get('notifLogin')); ?>
    ...
    <?php /**PATH D:\Shared drives\PSI - ALOEVERA\pabw base\pabw_plesirjogja\resources\views/layouts/app.blade.php ENDPATH**/ ?>